...
const SOCIALS = [
    { icon: '🐙', label: 'GitHub', href: 'https://github.com/nisarg' },
    { icon: '💼', label: 'LinkedIn', href: 'https://linkedin.com/in/nisarg' },
    { icon: '📧', label: 'Email', href: 'mailto:nisarg@email.com' },
]

const INFO = [
    { icon: '📧', label: 'Email', val: 'nisarg@email.com' },
